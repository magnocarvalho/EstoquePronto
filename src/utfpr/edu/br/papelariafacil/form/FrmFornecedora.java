 ...
 * @author magno
 */
public class FrmFornecedora extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmFornecedora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmFornecedora().setVisible(true);
            }
        });
    }
    ...
    private void obterPorNomeFantasia()
    {
        try {
            forne.clear();
